 ...
 *         description: Трек не найден
 */
router.put('/:id', authMiddleware, ownerMiddleware(Track), trackValidation, validate, trackController.updateTrack);
 ...
 *         description: Трек не найден
 */
router.put('/:id/cover', authMiddleware, ownerMiddleware(Track), uploadImage.single('file'), trackController.updateCover);
 ...
 *         description: Трек не найден
 */
router.delete('/:id', authMiddleware, ownerMiddleware(Track), trackController.deleteTrack);
 ...
 *         description: Трек не найден
 */
router.post('/:id/play', authMiddleware, trackController.incrementPlayCount);
